...
class ReactionGibbsandEquilibrium:
    ...
    def __init__(self, reaction_input: dict, use_log_K: bool = False):
    ...
    def get_reaction_gibbs_and_equilibrium(
        ...
        return {"g": gibbs_free_energy, "k": equilibrium_constant} if log_K else {"g": gibbs_free_energy, "log_k": equilibrium_constant}
